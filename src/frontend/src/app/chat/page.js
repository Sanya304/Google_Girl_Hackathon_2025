    ...
    <div>
      <div className="flex h-full">
        ...
        <div className="w-[35%] bg-blackish">
          <div className="bg-grey-800 text-accent text-center p-5 pt-8">
            <Link href="/">
              <h1 className="font-black leading-5 text-[2rem]">TaxEraAI</h1>
            </Link>

            <p className="text-lg">Your AI-Driven Tax Partner. 💸🏛️</p>
            ...
            <div className="mt-3">
              ...
              <select
                id="formSelect"
                className="px-4 py-2 mt-1 text-black rounded-xl focus:outline-0"
          ...
          <div className="p-5 pb-2">
            <h1 className="text-white text-2xl font-bold"> AI Agent</h1>
            <ChatWindow />
          </div>
        </div>
      </div>
      <div className="bg-black w-full py-4 text-center text-white"></div>
    </div>
  );
}
